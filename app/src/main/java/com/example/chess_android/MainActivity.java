...
import com.example.chess_android.Pieces.Bishop;
import com.example.chess_android.Pieces.King;
import com.example.chess_android.Pieces.Knight;
import com.example.chess_android.Pieces.Pawn;
import com.example.chess_android.Pieces.Piece;
import com.example.chess_android.Pieces.Queen;
import com.example.chess_android.Pieces.Rook;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public ArrayList<Position[][]> LastMoves = new ArrayList<Position[][]>();
    ...
    private void saveBoard() {
        ...
        for (int i = 0; i < 8; i++) {
            for (int j = 0; j < 8; j++) {
                LastMoves.get(numberOfMoves-1)[i][j]=new Position();
            }
        }
